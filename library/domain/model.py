...
class Book:
    ...
    def average_rating(self, rating: str):
        self.__average_rating = int(float(rating))
    ...
    def add_author(self, author: Author):
        ...
        if author.full_name in self.__authors:
            return

        if self.__authors == "":
            self.__authors += '{}'.format(author.full_name)
        else:
            self.__authors += ', {}'.format(author.full_name)
    ...
    def remove_author(self, author: Author):
        ...
        if author.full_name in self.__authors:
            self.__authors.repalce(',{}'.format(author.full_name), '')
